...
#         time.sleep(settings.INTER_AGENT_DELAY_S)
...
def run_cycle(
    ...
    try:
        ...
        # check the most likely candidates defensively.
        _impact_report_dict = imp.to_dict()
        impacted_node_ids: list[str] = (
            _impact_report_dict.get("impacted_node_ids")
            or _impact_report_dict.get("impacted_ids")
            or _impact_report_dict.get("node_ids")
            or []
        )
